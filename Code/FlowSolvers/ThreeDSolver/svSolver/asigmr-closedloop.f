...
c
        ...
        subroutine AsIGMR2 (y,       ac,      x,       xmudmi,
     &                     shp,     shgl,    ien,
     &                     res,     qres,
     &                     xKebe,   xGoC,    rerr, elem_prop_K)
...
c......................Declaration.....................................
      INTEGER ien
      REAL*8 y,ac,x,xmudmi,shp,shgl,res,qres,xkebe,xgoc,cflworst,acl
      REAL*8 dwl,ql,rl,rls,rlsl,sgn,xl,yl, elem_prop_K
c......................................................................
     ...
     &            ien(npro,nshl),
     &            res(nshg,nflow),
     &            qres(nshg,idflx), elem_prop_K(npro,npermprop)
...
c
        ...
        if(iporouspen .eq. 1) then
          call e3k  (yl,      acl,     dwl,     shp,
     &            shgl,    xl,      rl,
     &            ql,      xKebe,   xGoC,    xmudmi,
     &            sgn,     rerrl,  rlsl,     elem_prop_K)
        else
         call e3  (yl,      acl,     dwl,     shp,
     &            shgl,    xl,      rl,
     &            ql,      xKebe,   xGoC,    xmudmi,
